...
export default function CreateWifiQRCode() {
    ...
    const generateWifiQRCode = () => {
        const wifiString = `WIFI:T:WPA;S:${ssid};P:${password};H:;;`;
            ...
            <main className="flex min-h-screen flex-col items-center justify-between p-24">
                <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
                    <p className="fixed left-0 top-0 flex w-full justify-center border-b border-gray-300 bg-gradient-to-b from-zinc-200 pb-6 pt-8 backdrop-blur-2xl dark:border-neutral-800 dark:bg-zinc-800/30 dark:from-inherit lg:static lg:w-auto  lg:rounded-xl lg:border lg:bg-gray-200 lg:p-4 lg:dark:bg-zinc-800/30">
                        ...
                        <code className="font-mono font-bold">WiFi QR</code>
                        &nbsp;code
                    </p>
                    <div
                ...
                <div className={`flex items-center justify-center`}>
                    <div className={`w-full`}>
                        <h3 className="text-xl font-bold mb-4">Generate WiFi QR Code</h3>
                        <div className={`grid grid-cols-2`}>
                            <div>
                                <div className="mb-4">
                                    <label className="block mb-1 text-sm font-medium">Network Name (SSID)</label>
                                    <input
                                        type="text"
                                        value={ssid}
                                ...
                                <button
                                    ...
                                    className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-4 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Generate QR Code
                                </button>
                                {qrValue && (
